...
import (
	...
	"github.com/owncloud/ocis/search/pkg/version"
...
// ParseConfig loads search configuration from Viper known paths.
...
func NewSutureService(cfg *ociscfg.Config) suture.Service {
	if cfg.Mode == 0 {
		cfg.Search.Supervised = true
	}
	cfg.Search.Log.File = cfg.Log.File
