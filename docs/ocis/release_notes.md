...
- A context menu for a file/folder in ownCloud Web has been introduced and contains related actions (in addition to the actions in the right sidebar) [#5160](https://github.com/owncloud/web/issues/5160)
